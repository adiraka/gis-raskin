    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-content">
                <h4 class="card-title">Hapus Bantuan -
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        ?>
                        <form action="cores/dashboard/bantuan/delete-bantuan-process.php" method="post" accept-charset="utf-8">
                            <input type="hidden" name="id" id="id" value="<?php echo $data['id'] ?>"><br>
                            <div class="form-group label-floating">
                                <label class="control-label" for="nama">Nama Bantuan</label>
                                <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $data['nama_bantuan'] ?>" readonly>
                            </div>
                            <div class="form-group label-floating">
                                <label class="control-label" for="banyak">Banyak Bantuan</label>
                                <input type="text" class="form-control" name="banyak" id="banyak" value="<?php echo $data['banyak_bantuan'] ?>" readonly>
                            </div>
                            ...
                            <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" name="nominal" id="nominal" value="<?php echo $data['nominal'] ?>" readonly>
                            </div><br>
